...
import { AppBar, Box, Button, Fab, IconButton, Menu, MenuItem, Toolbar, Typography, useScrollTrigger, Zoom } from '@mui/material';
...
const MenuBar = (props: Props) => {
	...
	const ScrollTop = (props: Props) => {
		...
		return (
			<Zoom in={trigger}>
				<Box onClick={handleClick} role='presentation' sx={{ position: 'fixed', bottom: 16, right: 40 }}>
					{children}
				</Box>
			</Zoom>
		);
