...
const HomePage = () => {
  ...
  return (
    <Wrapper>
      ...
      <Typography align='center' variant='h5'>The tool to organize all your <Link
        className='link'
        href='https://adventofcode.com/'
      >AOC</Link> tasks.</Typography>
      <br />
      <Divider />
      <br />
      <Typography variant='body1'>You can start with a <span
        className='link'
        onClick={() => navigate('/tracker/basic')}
      >basic Table </span>
                                  ...
                                  You are able to set all your preferences. For example you can select for everyday a
