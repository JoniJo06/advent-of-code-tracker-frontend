...
const HomePage = () => {
  ...
  return (
    <Wrapper>
      ...
      <Divider />
      <br/>
      <Typography variant='body1'>You can start with a <span className='link' onClick={()=> navigate('/tracker/basic')}>basic Table</span> or create a custom Table. You are able to set all
